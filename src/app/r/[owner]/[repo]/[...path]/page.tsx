...
import { getPackageDetail, permalink } from '@/db/queries/packages';
  ...
  return (
    <>
      ...
      <p className="muted">
        ...
        as published by {detail.fullName}, at commit {detail.commitSha.slice(0, 7)}. AgentDock reads
        this file; it does not run it, and it cannot say whether it is safe.
      </p>
      <div className="body">
